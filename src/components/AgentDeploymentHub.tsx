      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <div className="text-base text-slate-800/80">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-white p-3">
            <div className="text-base text-slate-800">Selected Agent</div>
            <select
              value={selectedAgent}
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-3">
            <div className="text-base text-slate-800">Ops</div>
            <button
          ...
          <div className="mt-3 space-y-2">
            {tasks.slice(0, 20).map((t) => (
              <div key={t.id} className="rounded-xl border border-slate-200 bg-white p-3">
                ...
                <div className="mt-2 text-base text-slate-800">Workflow: {t.input?.workflowId ?? "—"}</div>
              </div>
            ))}
