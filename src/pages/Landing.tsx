      ...
      <main className="mx-auto max-w-6xl px-6 py-12 relative z-10">
        ...
        <section id="updates" className="mt-14 rounded-3xl border border-white/10 bg-white/5 p-6">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-white/75">
            ...
            <li>Atlas AI Avatar — blue wireframe holographic robot head in the app header (exported from Blender 3D sci-fi armor model) with live heartbeat indicator: green pulse (online/idle), purple pulse (jobs running), red pulse (pending decisions need attention); click to see status popover with active job count, pending decisions, and quick "Open Chat" button; 3D model via Three.js/React Three Fiber</li>
