      ...
      <main className="relative z-10">
        ...
        <section id="updates" className="mt-14 rounded-3xl border border-white/10 bg-white/5 p-6">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-white/75">
            ...
            <li>[Claude Code] Wired OAuth for 6 new providers — Notion, Airtable (PKCE), Dropbox, Slack, PayPal, and Square now fully integrated into the OAuth flow; connect/disconnect from Integrations tab; token refresh for Airtable/Dropbox/PayPal/Square; Slack redirect built from APP_URL at runtime; Square handles ISO expires_at; Notion stores workspace metadata</li>
