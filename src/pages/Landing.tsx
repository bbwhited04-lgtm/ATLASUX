      ...
      <main className="mx-auto max-w-6xl px-6 py-12 relative z-10">
        ...
        <section id="updates" className="mt-14 rounded-3xl border border-white/10 bg-white/5 p-6">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-white/75">
            ...
            <li>Advanced AI capabilities — 14 KB docs: autonomous brainstorming (SCAMPER, Six Thinking Hats, reverse brainstorming), creative problem solving (TRIZ, Design Thinking, First Principles), innovation pipeline (Three Horizons), strategic reasoning (Chain-of-Thought, Tree-of-Thought, Bayesian), decision frameworks (OODA, Cynefin, pre-mortem), systems thinking (Meadows leverage points), cognitive bias defense (25 biases with countermeasures), TINY CRABS prompt engineering framework, multi-agent orchestration patterns, agent communication protocols, agent scaling &amp; load management, agent lifecycle management, data governance, and data quality management</li>
          </ul>
