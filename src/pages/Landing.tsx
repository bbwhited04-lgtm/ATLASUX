      ...
      <main className="mx-auto max-w-6xl px-6 py-12 relative z-10">
        ...
        <section id="updates" className="mt-14 rounded-3xl border border-white/10 bg-white/5 p-6">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-white/75">
            ...
            <li>[Claude Code] Fixed Vercel white screen — legacy `routes` config was serving index.html for JS/CSS asset requests; switched to `rewrites` which only applies to non-static paths; fixed FloatingAtlas not rendering (was imported in dead App.tsx instead of the real entry point main.tsx)</li>
          </ul>
