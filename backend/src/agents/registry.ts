...
export const agentRegistry: AgentSummary[] = [
  ...
  withM365("binky", {
    ...
    toolsAllowed: ["Docs drafting", "Email", "Read-only dashboards", "Web research", "M365 Outlook/Teams/Word/Excel/PowerPoint/OneNote/Planner/Calendar"],
  ...
  withM365("tina", {
    ...
    toolsAllowed: ["Ledger writer", "Accounting reports", "Email", "Budget rules editor", "Spend alerts", "M365 Outlook/Teams/Excel/Word/OneNote/Planner/Calendar"],
  ...
  withM365("larry", {
    ...
    toolsAllowed: ["Policy reader", "Docs", "Email", "M365 Outlook/Teams/Word/Excel/OneNote/Planner/SharePoint"],
  ...
  withM365("jenny", {
    ...
    toolsAllowed: ["Docs reading", "Policy editor (proposal)", "M365 Outlook/Teams/Word/OneNote/Planner/SharePoint"],
  ...
  withM365("benny", {
    ...
    toolsAllowed: ["Docs reading", "IP register editor (proposal)", "M365 Outlook/Teams/Word/OneNote/Planner/SharePoint"],
  ...
  withM365("cheryl", {
    ...
    toolsAllowed: ["Email inbox (support@)", "Ticket system", "Documentation/KB", "Escalation router", "get_subscription_info", "get_team_members", "search_atlasux_knowledge", "M365 Outlook/Teams/Word/OneNote/Planner/Calendar/Bookings"],
  ...
  withM365("daily-intel", {
    ...
    toolsAllowed: ["Web research", "Docs reading", "Email drafting", "M365 Outlook/Teams/Word/Excel/OneNote/Planner/SharePoint"],
    toolsForbidden: ["Execution tools"],
  ...
  withM365("archy", {
    ...
    toolsAllowed: ["Web research", "Docs reading", "Spreadsheet drafting", "M365 Outlook/Teams/Word/Excel/PowerPoint/OneNote/Planner/SharePoint"],
    toolsForbidden: ["Execution tools"],
    escalationTargets: ["binky"],
  }),
  withM365("venny", {
    ...
    toolsAllowed: ["Video editor", "OneDrive write", "Content scheduler", "YouTube API", "Flux1 image generation", "M365 Clipchamp/PowerPoint/Word/OneNote/Outlook"],
    toolsForbidden: ["Publishing without Atlas approval"],
  ...
  withM365("penny", {
    ...
    toolsAllowed: ["Facebook Ads API", "Meta Business Suite", "Content scheduler", "M365 Outlook/Teams/Word/Excel/PowerPoint/OneNote/OneDrive/SharePoint"],
  ...
  withM365("donna", {
    ...
    toolsAllowed: ["Reddit API", "Docs drafting", "M365 Outlook/Teams/Word/PowerPoint/Clipchamp/OneNote/OneDrive/SharePoint"],
  ...
  withM365("cornwall", {
    ...
    toolsAllowed: ["Pinterest API", "Image assets", "Content scheduler", "M365 Outlook/Teams/Word/Excel/OneNote/OneDrive/SharePoint"],
    toolsForbidden: ["Publishing without Atlas approval"],
    escalationTargets: ["sunday", "atlas"],
  }),
  withM365("link", {
    ...
    toolsAllowed: ["LinkedIn API", "Docs drafting", "Content scheduler", "M365 Outlook/Teams/Word/PowerPoint/OneNote/OneDrive/SharePoint"],
    toolsForbidden: ["Publishing without Atlas approval"],
    escalationTargets: ["sunday", "atlas"],
  }),
  withM365("dwight", {
    ...
    toolsAllowed: ["Threads API", "Content scheduler", "M365 Outlook/Teams/Word/OneNote/OneDrive/SharePoint"],
    toolsForbidden: ["Publishing without Atlas approval"],
    escalationTargets: ["sunday", "atlas"],
  }),
  withM365("reynolds", {
    ...
    toolsAllowed: ["Blog CMS", "Docs drafting", "Content scheduler", "M365 Outlook/Teams/Word/PowerPoint/OneNote/OneDrive/SharePoint"],
    toolsForbidden: ["Publishing without Atlas approval"],
    escalationTargets: ["sunday", "atlas"],
  }),
  withM365("emma", {
    ...
    toolsAllowed: ["Alignable API", "Docs drafting", "Email drafting", "M365 Outlook/Teams/Word/OneNote/Calendar/Planner/Bookings/OneDrive/SharePoint"],
    toolsForbidden: ["Publishing without Atlas approval"],
    escalationTargets: ["sunday", "atlas"],
  }),
  withM365("fran", {
    ...
    toolsAllowed: ["Facebook Graph API", "Content scheduler", "M365 Outlook/Teams/Word/PowerPoint/Clipchamp/OneNote/OneDrive/SharePoint"],
    toolsForbidden: ["Publishing without Atlas approval"],
    escalationTargets: ["sunday", "atlas"],
  }),
  withM365("kelly", {
    ...
    toolsAllowed: ["X (Twitter) API", "Content scheduler", "M365 Outlook/Teams/Word/OneNote/OneDrive/SharePoint"],
    toolsForbidden: ["Publishing without Atlas approval"],
    escalationTargets: ["sunday", "atlas"],
  }),
  withM365("terry", {
    ...
    toolsAllowed: ["Tumblr API", "Content scheduler", "M365 Outlook/Teams/Word/PowerPoint/OneNote/OneDrive/SharePoint"],
    toolsForbidden: ["Publishing without Atlas approval"],
    escalationTargets: ["sunday", "atlas"],
  }),
  withM365("timmy", {
    ...
    toolsAllowed: ["TikTok API", "Video assets", "Content scheduler", "M365 Outlook/Teams/Word/OneNote/Clipchamp/OneDrive/SharePoint"],
    toolsForbidden: ["Publishing without Atlas approval"],
    escalationTargets: ["sunday", "atlas"],
  }),
  withM365("sunday", {
    ...
    toolsAllowed: ["Docs drafting", "M365 Outlook/Teams/Word/PowerPoint/Clipchamp/OneNote/Planner/OneDrive/SharePoint"],
  ...
  withM365("mercer", {
    ...
    toolsAllowed: ["Email drafting", "Docs reading", "Web research", "M365 Outlook/Teams/Word/Excel/PowerPoint/OneNote/Planner/Calendar/Bookings/OneDrive/SharePoint"],
    toolsForbidden: ["Execution tools"],
    escalationTargets: ["atlas"],
    deepMode: true,
  }),
  ...
  withM365("petra", {
    ...
    toolsAllowed: ["Planner write", "Docs drafting", "Teams draft", "M365 Outlook/Teams/Planner/Word/OneNote/Calendar/OneDrive/SharePoint"],
  ...
  withM365("porter", {
    ...
    toolsAllowed: ["SharePoint read/write", "Docs drafting", "M365 Outlook/Teams/Word/PowerPoint/OneNote/OneDrive/SharePoint"],
  ...
  withM365("claire", {
    ...
    toolsAllowed: ["Calendar read/write", "Email drafting", "Meeting draft", "M365 Outlook/Teams/Calendar/Planner/Bookings/Word/OneNote/OneDrive/SharePoint"],
    toolsForbidden: ["Execution tools"],
  ...
  withM365("victor", {
    ...
    tier: "Subagent",
    reportsTo: "venny",
    summary: "Manages video production pipeline: source media → edit (Clipchamp/FFmpeg/ComfyUI) → export → OneDrive → YouTube upload via Venny.",
    toolsAllowed: ["Clipchamp write", "OneDrive write", "YouTube search", "FFmpeg", "ComfyUI", "M365 Outlook/Teams/Clipchamp/Word/PowerPoint/OneNote/OneDrive/SharePoint"],
    toolsForbidden: ["Publishing without Atlas approval"],
  ...
  withM365("frank", {
    ...
    toolsAllowed: ["Forms read/create", "Excel read/write", "Docs reading", "M365 Outlook/Teams/Word/Excel/OneNote/Planner/OneDrive/SharePoint"],
    toolsForbidden: ["Execution tools"],
    escalationTargets: ["binky"],
  }),
  withM365("sandy", {
    ...
    toolsAllowed: ["Bookings read/manage", "Calendar read/write", "Email drafting", "M365 Outlook/Teams/Bookings/Calendar/Word/OneNote/Planner/OneDrive/SharePoint"],
    toolsForbidden: ["Execution tools"],
