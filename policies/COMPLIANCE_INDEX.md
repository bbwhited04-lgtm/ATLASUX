...
| HIPAA | `HIPAA_COMPLIANCE.md` | Not compliant | N/A until PHI | No BAA, no Security Officer |
...
| GDPR | `GDPR_COMPLIANCE.md` | Partial | ~75% | No DPO, no DPIA, DeepSeek transfer |
...
| No formal ISMS | Cannot certify ISO | ISO 27001 | Document ISMS scope |
| No DPO appointed | GDPR Art. 37 | GDPR | Appoint DPO |
| No DPIA conducted | GDPR Art. 35 | GDPR | Conduct DPIA for AI processing |
| No BAA template | Cannot accept PHI | HIPAA | Draft BAA |
| No HIPAA Security Officer | §164.308(a)(2) | HIPAA | Assign role |
...
| DeepSeek (China) transfer | No adequacy/SCCs | GDPR | Assess transfer mechanism |
| No SAST/DAST pipeline | Development security | ISO, PCI | Add to CI/CD |
| `FORCE ROW LEVEL SECURITY` not enabled | RLS bypass possible | All | Enable after migration |
